# Palworld Specifications

Palworld is the fully supported game integration.
...
- [World Settings](./components/instance-world-settings.md)
- [Mods](./components/instance-mods.md)
...
- [Crash Restart & Self-Heal](./features/crash-restart-and-self-heal.md)
- [Scheduled Backups](./features/scheduled-backups.md)
- [Player Management](./features/player-management.md)
- [World Settings](./features/world-settings.md)
